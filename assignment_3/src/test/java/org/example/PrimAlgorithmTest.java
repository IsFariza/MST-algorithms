...
public class PrimAlgorithmTest {
    ...
    void testConnectivity(){
        ...
        assertFalse(result.getEdges().isEmpty() || TestUtils.isConnected(result.getEdges(), nodes));
    ...
    void testReproducibility(){
        ...
        PrimAlgorithm prim = new PrimAlgorithm();
        MSTResult result1 = prim.primAlgorithm(graph);
        MSTResult result2 = prim.primAlgorithm(graph);
